...
const  int  max1_LED8            = 4095;  // Fourth LED maximum intensity 1
const  int  max2_LED8            = 2000;  // Fourth LED maximum intensity 2

const  int  max1_LED9            = 4095;  // First LED maximum intensity 1
const  int  max2_LED9            = 2000;  // First LED maximum intensity 2

const  int  max1_LED10            = 4095;  // Second LED maximum intensity 1
const  int  max2_LED10            = 2000;  // Second LED maximum intensity 2

const  int  max1_LED11            = 4095;  // Third LED maximum intensity 1
const  int  max2_LED11            = 2000;  // Third LED maximum intensity 2

const  int  max1_LED12            = 4095;  // Fourth LED maximum intensity 1
const  int  max2_LED12            = 2000;  // Fourth LED maximum intensity 2
